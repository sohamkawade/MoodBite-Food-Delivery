...
import { MdArrowBack, MdCheckCircle, MdError, MdAdminPanelSettings } from "react-icons/md";
...
const AdminForgotPassword = () => {
  ...
  const handleVerifyOtp = async (e) => {
    ...
    try {
      await adminAPI.verifyOTP(email, otpString);
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const otpString = otp.join("");
      await adminAPI.resetPassword(email, otpString, newPassword);
            ...
            <div className="text-center">
              ...
              <form onSubmit={handleVerifyOtp} className="space-y-4">
                <div className="flex justify-center space-x-2">
                  {otp.map((digit, index) => (
                    <input
                      ...
                      className="w-10 h-10 sm:w-12 sm:h-12 text-center text-lg sm:text-xl font-bold border-2 border-gray-300 rounded-lg focus:border-red-500 focus:outline-none focus:ring-2 focus:ring-red-200"
                    />
                  ))}
                </div>
                ...
                <button
                  ...
                  className="w-full bg-red-500 text-white py-2 px-4 rounded-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <Link
                  to="/admin/login"
                  className="flex items-center justify-center w-full text-red-600 hover:text-red-700 font-medium py-2"
                >
          ...
          <div className="text-center mb-6">
            <div className="flex justify-center mb-4">
              <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center">
                <MdAdminPanelSettings size={32} className="text-red-600" />
              </div>
            </div>
