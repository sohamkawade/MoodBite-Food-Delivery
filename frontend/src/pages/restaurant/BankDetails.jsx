        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 sm:p-6 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Payment & Earnings</h1>
                <p className="text-gray-600 text-sm">Manage your bank details and track earnings</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">₹{restaurantInfo.totalEarnings.toLocaleString()}</p>
                  </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">₹{restaurantInfo.pendingAmount.toLocaleString()}</p>
                  </div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-gray-900">{restaurantInfo.totalOrders}</p>
                  </div>
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-xl font-semibold text-gray-900">{restaurantInfo.commissionRate}%</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Next Payout</p>
                  <p className="text-xl font-semibold text-gray-900">
                    {restaurantInfo.nextPayoutDate ? new Date(restaurantInfo.nextPayoutDate).toLocaleDateString() : 'Not scheduled'}
                  </p>
                </div>
              </div>
            </div>
